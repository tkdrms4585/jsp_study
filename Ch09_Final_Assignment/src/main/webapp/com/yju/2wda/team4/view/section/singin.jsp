...
<body>
	<div class="container">
		...
		<div class="container2">
			...
			<section class="first py-5 text-center container">
				<div class="row py-lg-5">
					<div class="col-lg-6 col-md-8 mx-auto">
						<div id="page">
							...
							<!-- 회원가입 시작 -->
							<div id="join">
								<form action="/com/yju/2wda/team4/controller/artholic/userController.jsp" method="post" id="form">
									<label for="userID">아이디</label>
									<input type="text" placeholder="ID" name="userID" maxlength="20" id="user_id">
									<br><br>
									...
									<input type="hidden" name="actionType" value="singup">
