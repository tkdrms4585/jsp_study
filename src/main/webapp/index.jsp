		...
		<div class="row gx-4 gx-lg-5 justify-content-center">
			<div class="col-lg-8">
				...
				<p class="text-white-50">
					나 한명의 성공보다는 모두의 성공을 꿈꿉니다. <br> 실력이 있지만 인정받지 못하거나, 노력하지만 빛을 보지
					못하는 사람에게 도움이 되고 싶습니다.
				</p>
			</div>
		</div>
		<img class="img-fluid" src="assets/img/불꽃놀이.png" alt="..."
			style="width: 50%;" />
		...
		<div class="container px-4 px-lg-5">
			...
			<div class="social d-flex justify-content-center">
				<a class="mx-2" href="#!"><i class="fab fa-twitter"></i></a> <a
					...
					class="mx-2" href="https://github.com/tkdrms4585" target="_blank"><i
